...
const typeColor: Record<string, string> = {
  'check-in': 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900 dark:text-emerald-300',
  'check-out': 'bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-300',
  'break-in': 'bg-amber-100 text-amber-700 dark:bg-amber-900 dark:text-amber-300',
  'break-out': 'bg-amber-100 text-amber-700 dark:bg-amber-900 dark:text-amber-300',
}
                ...
                {dayEntries.map((entry) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <Badge variant="secondary" className={typeColor[entry.type]}>
